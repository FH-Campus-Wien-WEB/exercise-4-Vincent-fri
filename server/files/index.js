...
window.onload = function () {
  ...
  function renderUserGreeting() {
    ...
    if (currentSession) {
      ...
      const dateStr = loginDate.toLocaleDateString('de-AT', { day: 'numeric', month: 'long', year: 'numeric' });
      const timeStr = loginDate.toLocaleTimeString('de-AT', { hour: '2-digit', minute: '2-digit' });
